...
/**
 * @Author 55HAITAO
 * @Date 2019-05-22 09:38
 */
class SearchDealAdapter(private val mActivity: Activity?, list: List<DealItemModel>) : BaseQuickAdapter<DealItemModel, BaseViewHolder>(R.layout.item_search_deal, list) {
