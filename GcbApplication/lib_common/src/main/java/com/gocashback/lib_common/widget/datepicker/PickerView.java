package com.gocashback.lib_common.widget.datepicker;
...
import com.gocashback.lib_common.utils.ScreenUtilsKt;
...
public class PickerView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float maxTextSize = ScreenUtilsKt.dp2px(getContext(), 160) / 10f;
        mMinTextSize = maxTextSize / 2.2f;
        mTextSizeRange = maxTextSize - mMinTextSize;
        mTextSpacing = maxTextSize * 3;
