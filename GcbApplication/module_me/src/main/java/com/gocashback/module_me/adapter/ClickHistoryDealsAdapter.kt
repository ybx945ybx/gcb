 ...
 */
class ClickHistoryDealsAdapter(list: List<BrowsingHistoryItemModel>, private val mActivity: Activity?) : BaseQuickAdapter<BrowsingHistoryItemModel, BaseViewHolder>(R.layout.item_click_history_deals, list) {
